...
# ==== library
libraries += libam
objects.libam = libam_cqueue.o  libam_fdopers.o  libam_time.o libam_opts.o  libam_stats.o  libam_tree.o libam_itree.o libam_hash.o libam_stack.o libam_lstack.o libam_pool.o libam_log.o
