...
static amrc_t globals_init()
{
	...
	stack = amstack_alloc(STACK_SIZE);
	if (stack == NULL) {
...
int main()
{
	...
	printf("libam testing of amstack_t starting.");
	fflush(stdout);
	for (i = 0; i < 10; i++) {
		run_readers();
		printf(".");
